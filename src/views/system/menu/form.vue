        ...
        <el-form ref="form" :model="form" :rules="rules" size="small" label-width="80px">
            <el-form-item label="菜单图标">
                <el-popover
                    ...
                    <el-input slot="reference" v-model="form.icon" style="width: 460px;" placeholder="点击选择图标" clearable>
            ...
            <el-form-item label="元素ID">
                <el-input v-model="form.elementId" placeholder="" style="width: 460px;"/>
            </el-form-item>
            ...
            getMenus() {
                getMenusTree().then(res => {
                    ...
                    menu.children = res.data.records.map(item => {
                        ...
                        if (children) {
                            return {children: children, id: item.id, label: item.name};
                        } else {
