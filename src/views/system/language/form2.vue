    ...
    <el-dialog :append-to-body="true"
        ...
        <div class="config">
            <el-form ref="form" :model="form" :rules="rules" label-width="200px">
                ...
                <el-form-item label="zh-CN" prop="zh">
                    <el-input v-model="form.zh" placeholder="请输入内容" :clearable="true" style="width: 240px"/>
                </el-form-item>
                <el-form-item label="en" prop="en">
                    <el-input v-model="form.en" placeholder="请输入内容" :clearable="true" style="width: 240px"/>
                </el-form-item>
                <!--<el-form-item label="类型" prop="locale">-->
                    <!--<el-select v-model="form.locale" filterable placeholder="选择国际化语音类型"-->
                               <!--:clearable="true"-->
                               <!--style="width: 240px">-->
                        <!--<el-option v-for="item in LOCAL_TYPES" :key="item.id" :label="item.label"-->
        ...
        data() {
            return {
                ...
                rules: {
                    ...
                    zh: [this.getRequiredRole('请输入国际化语言内容')],
                    en: [this.getRequiredRole('请输入国际化语言类型')],
                },
