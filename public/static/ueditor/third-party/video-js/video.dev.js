...
// usage: media('inside coolFunc',this,arguments);
...
//   vjs.media('unloadingTech')
//   this.unloadTech();
//   vjs.media('unloadedTech')
//   if (betweenFn) { betweenFn.call(); }
//   vjs.media('LoadingTech')
//   this.loadTech(this.techName, { src: this.cache_.src })
//   vjs.media('loadedTech')
// },
...
vjs.Player.prototype.trackProgress = function(){
  ...
  this.progressInterval = setInterval(vjs.bind(this, function(){
    ...
    // media(this.cache_.bufferEnd, this.buffered().end(0), this.duration())
...
vjs.ChaptersTrackMenuItem.prototype.update = function(){
  ...
  // vjs.media(currentTime, cue.startTime);
